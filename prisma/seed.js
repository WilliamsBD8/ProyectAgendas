...
async function main() {
  ...
  const permissions = [
    ...
    { name: "CREATE_SITE", type: "CREATE", id: null },
    { name: "READ_SITES", type: "READ", id: null },
    { name: "UPDATE_SITE", type: "UPDATE", id: null },
    { name: "DELETE_SITE", type: "DELETE", id: null },
    { name: "CREATE_EVENT", type: "CREATE", id: null },
    { name: "READ_EVENTS", type: "READ", id: null },
    { name: "UPDATE_EVENT", type: "UPDATE", id: null },
    { name: "DELETE_EVENT", type: "DELETE", id: null },
    { name: "CREATE_AGENDA", type: "CREATE", id: null },
    { name: "UPDATE_AGENDA", type: "UPDATE", id: null },
    { name: "DELETE_AGENDA", type: "DELETE", id: null },
    { name: "CREATE_TICKET", type: "CREATE", id: null },
    { name: "READ_TICKETS", type: "READ", id: null },
    { name: "VALIDATE_TICKET", type: "UPDATE", id: null },
    { name: "CREATE_NOTIFICATION", type: "CREATE", id: null },
    { name: "READ_NOTIFICATIONS", type: "READ", id: null },
    { name: "UPDATE_NOTIFICATION", type: "UPDATE", id: null },
    { name: "CREATE_SURVEY", type: "CREATE", id: null },
    { name: "READ_SURVEYS", type: "READ", id: null },
    { name: "CREATE_SURVEY_RESPONSE", type: "CREATE", id: null },
    { name: "READ_SURVEY_RESPONSES", type: "READ", id: null },
  ];
